...
public class IoHelper {
    ...
    public static void copy(String content,OutputStream out,String character){
        try {
            copy(new StringReader(content),out,character);
        } catch (IOException e) {
            throw StdException.adapt(e);
        }
    }
    ...
    public static byte[] toByteArray(Reader input, Charset encoding) throws IOException {
        org.apache.commons.io.output.ByteArrayOutputStream output = new ByteArrayOutputStream();
